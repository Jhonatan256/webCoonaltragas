...
import {
  CSSTransition
} from "./chunk-GYECPT2E.js";
import "./chunk-Z4TIODHZ.js";
import "./chunk-BKAVQVOF.js";
import {
  ComponentBase,
  useHandleStyle,
  useMergeProps,
  useMountEffect,
  useUpdateEffect
} from "./chunk-KQDAKRER.js";
import {
  ObjectUtils,
  PrimeReactContext,
  UniqueComponentId,
  classNames
} from "./chunk-7EK6J5LU.js";
import {
  require_react
...
var StepperHeader = React.memo(React.forwardRef(function(props, ref) {
  ...
  return props.template ? props.template() : React.createElement("button", buttonProps, React.createElement("span", numberProps, props.index + 1), React.createElement("span", titleProps, props.getStepProp(props.stepperpanel, "header")));
}));
...
var Stepper = import_react.default.memo(import_react.default.forwardRef(function(inProps, ref) {
  ...
  useUpdateEffect(function() {
    if (props.activeStep >= 0 && props.activeStep <= stepperPanels().length - 1) {
      updateActiveStep(void 0, props.activeStep);
    }
  }, [props.activeStep]);
  ...
  return import_react.default.createElement("div", rootProps, start && import_react.default.createElement("div", startProps, start), props.orientation === "horizontal" && createHorizontal(), props.orientation === "vertical" && createVertical(), end && import_react.default.createElement("div", endProps, end));
}));
